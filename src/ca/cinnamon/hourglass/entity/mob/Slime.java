...
public class Slime extends Mob {
	...
	public void Tick(){
		...
		if(ticksSinceLastAction>100){
			...
			switch(randomNum){
			case 1: this.moveUp(currentMap.tiles[loc.x][loc.y-1]);
	    		ticksSinceLastAction=0;
	    	break;
	    	
			case 2:this.moveLeft(currentMap.tiles[loc.x-1][loc.y]);
	    		ticksSinceLastAction=0;
				break;
				
			case 3:this.moveDown(currentMap.tiles[loc.x][loc.y+1]);
				ticksSinceLastAction=0;
				break;
				
			case 4:this.moveRight(currentMap.tiles[loc.x+1][loc.y]);
				ticksSinceLastAction=0;
				break;	
		}
